...
public class MainMenuMahasiswa extends javax.swing.JFrame {
    ...
    public MainMenuMahasiswa(String np, String r) {
        initComponents();
//        setOpaque(false);
...
//        new Menu(String username, String password).setVisible(true);
    ...
    public void initMenu(EventMenu event) {
        ...
        addMenu(new ImageIcon(getClass().getResource("/assets/pinjambuku20x20.png")), "Peminjaman", 1);
        addMenu(new ImageIcon(getClass().getResource("/assets/kembalibuku20x20.png")), "Pengembalian", 2);
...
//        addMenu(new ImageIcon(getClass().getResource("/assets/homepage20x20.png")), "Homepage", 4);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MainMenuMahasiswa("Nama Pengguna", "Peran").setVisible(true);
            }
        });
    }
